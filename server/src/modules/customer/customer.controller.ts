import { Controller, Param, Body, Get, Post, Put, Delete, JsonController, Req, Res, UseBefore, UploadedFile } from 'routing-controllers';
...
export class CustomerController {
    ...
    @Get('/:id')
    @OpenAPI({ summary: 'Get customer by customer id', operationId: 'getCustomerById' })
    async getCustomerById(@Param('id') id: string, @Req() request: Request, @Res() response: Response) {
        try {
